...
def generate_makefile_baisc_config(
        board_repo_path:str,
        board_xsa_name:str,
...
def generate_makefile_include_oclxcl(include_dir:str) -> List[str]:
    return [
        f'include {include_dir}/opencl/opencl.mk\n',
        f'include {include_dir}/xcl2/xcl2.mk\n',
    ]

def generate_makefile_dir_config(build_dir:str, output_dir:str) -> List[str]:
    return [
...
def generate_makefile_kernel_config(kernel_name:str, target_frequency_mhz:int=300) -> List[str]:
    return [
...
def generate_makefile_host_config(include_dir:str) -> List[str]:
    return [
        'HOST_SRC := host.cpp\n',
        'HOST_EXE := host.exe\n',
...
def generate_makefile_emulation_config(
...
def generate_makefile_build_targets(test_case_name:str) -> List[str]:
    return [
...
def generate_makefile_clean_targets() -> List[str]:
    return [
...
def generate_makefile_run_targets() -> List[str]:
    return [
        '.PHONY: run\n',
